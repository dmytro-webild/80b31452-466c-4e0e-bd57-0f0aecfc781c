...
export const metadata: Metadata = {
  title: "Studio Arc | Minimalist Architecture & Design",  description: "Thoughtfully designed buildings and environments. Award-winning architecture studio specializing in residential, commercial, and institutional projects.",  keywords: "architecture, architectural design, studio, building design, minimalist architecture, sustainable design",  robots: {
    index: true,
    follow: true,
  },
  openGraph: {
    title: "Studio Arc | Minimalist Architecture & Design",    description: "Thoughtfully designed buildings and environments that balance form, function, and human experience.",    type: "website",    siteName: "Studio Arc",    images: [
      {
        url: "http://img.b2bpic.net/free-photo/architecture-shadows-city-day_23-2149451224.jpg",        alt: "Modern architectural building design"},
    ],
  },
  twitter: {
    card: "summary_large_image",    title: "Studio Arc | Minimalist Architecture & Design",    description: "Award-winning architecture studio creating exceptional spatial experiences.",    images: ["http://img.b2bpic.net/free-photo/architecture-shadows-city-day_23-2149451224.jpg"],
  },
};
